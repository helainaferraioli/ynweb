  ...
  return (
    <main className="flex flex-1 flex-col gap-0">
      ...
      <div className="relative w-full h-[75vh] md:h-[calc(100vh-130px)] md:mt-[130px]">
        <HeroVideo src="/Shortened%20Hero%20Video%202.mp4" poster="/video-poster.jpg" className="absolute inset-0 w-full h-full object-cover object-[65%_90%] md:object-center" />
